...
namespace HomeworkIPCalculator
{
    class IP
    {
        ...
        public string BiToSTR()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (i < 3)
                {
                    result = result + Convert.ToString(oktets[i], 2) + ".";
                }
                else
                {
                    result = result + Convert.ToString(oktets[i], 2);
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("ip-адрес: {0}", _ip.ToSTR());
            Console.WriteLine("Бинарный ip-адрес: {0}", _ip.BiToSTR());
            Console.WriteLine("маска: {0}", _mask.ToSTR());
            Console.WriteLine("Бинарная маска: {0}", _mask.BiToSTR());
        }
    }
}
